...
public class NBTTagCompound implements INBTTagCompound {
    ...
    public INBTTagCompound copyRawByteArray(byte[] bytes) {
        _tagCompound = (net.minecraft.server.v1_13_R2.NBTTagCompound) baseFromByteArray(NBTTagType.COMPOUND, bytes);
        return this;
    }
    ...
    protected byte[] baseToByteArray(NBTBase base){
        try{
            ...
            Method writeMethod = net.minecraft.server.v1_13_R2.NBTTagCompound.class.getDeclaredMethod("write", DataOutput.class);
