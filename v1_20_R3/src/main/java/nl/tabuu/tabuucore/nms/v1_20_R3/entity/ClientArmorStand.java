package nl.tabuu.tabuucore.nms.v1_20_R3.entity;
...
public class ClientArmorStand implements IClientArmorStand {
    ...
    public void sendPacketDestroy(Player player) {
        sendPacket(player, new PacketPlayOutEntityDestroy(getHandle().aj()));
    }
    ...
    public void sendPacketMetaData(Player player) {
        sendPacket(player, new PacketPlayOutEntityMetadata(getHandle().aj(), getHandle().an().b()));
    }
    ...
    public void sendPacketEquipment(Player player) {
        ...
        sendPacket(player, new PacketPlayOutEntityEquipment(_handle.aj(), equipment));
    }
