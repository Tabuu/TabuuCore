...
public class NBTTagCompound implements INBTTagCompound {
    ...
    public NBTTagCompound(net.minecraft.server.v1_12_R1.NBTTagCompound tagCompound){
    ...
    public INBTTagCompound copyRawByteArray(byte[] bytes) {
        _tagCompound = (net.minecraft.server.v1_12_R1.NBTTagCompound) baseFromByteArray(NBTTagType.COMPOUND, bytes);
        return this;
    }
    ...
    protected byte[] baseToByteArray(NBTBase base){
        try{
            ...
            Method writeMethod = net.minecraft.server.v1_12_R1.NBTTagCompound.class.getDeclaredMethod("write", DataOutput.class);
