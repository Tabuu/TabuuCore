...
public class NBTTagCompound implements INBTTagCompound {
    ...
    private net.minecraft.server.v1_14_R1.NBTTagCompound _tagCompound;

    public NBTTagCompound(){
        _tagCompound = new net.minecraft.server.v1_14_R1.NBTTagCompound();
    }

    public NBTTagCompound(net.minecraft.server.v1_14_R1.NBTTagCompound tagCompound){
