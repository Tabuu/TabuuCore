...
public class ItemList extends ArrayList<ItemStack> {
    ...
    /**
     * Removes ItemStacks for which {@link ItemStack#isSimilar(ItemStack providedItemStack)} is true.
     *
     * @param stack The ItemStack to be removed.
    ...
    public boolean containsAtLeast(ItemStack item, int amount) {
        int count = 0;
        for(ItemStack other : this) {
            if(other == null || !other.isSimilar(item)) continue;
