package nl.tabuu.tabuucore.nms.v1_20_R1.container;
...
public class AnvilContainerWindow extends ContainerWindow implements IAnvilContainerWindow {
    ...
    protected AnvilContainerWindow(Player player) {
        ...
        World world = getEntityPlayer().cH();
        BlockPosition blockPosition = new BlockPosition(0, 0, 0);
        _container = new ContainerAnvil(getId(), getEntityPlayer().fN(), ContainerAccess.a(world, blockPosition));
