package nl.tabuu.tabuucore.nms.v1_16_R1;
...
public class NBTTagCompound implements INBTTagCompound {
    ...
    private net.minecraft.server.v1_16_R1.NBTTagCompound _tagCompound;

    public NBTTagCompound(){
        _tagCompound = new net.minecraft.server.v1_16_R1.NBTTagCompound();
    }

    public NBTTagCompound(net.minecraft.server.v1_16_R1.NBTTagCompound tagCompound){
    ...
    public INBTTagCompound copyRawByteArray(byte[] bytes) {
        _tagCompound = (net.minecraft.server.v1_16_R1.NBTTagCompound) baseFromByteArray(NBTTagType.COMPOUND, bytes);
        return this;
    }
    ...
    public String toJson(org.bukkit.inventory.ItemStack item) {
        item = apply(item);
        net.minecraft.server.v1_16_R1.NBTTagCompound compound = new net.minecraft.server.v1_16_R1.NBTTagCompound();
