package nl.tabuu.tabuucore.nms.v1_16_R2;
...
public class NBTTagCompound implements INBTTagCompound {
    ...
    private net.minecraft.server.v1_16_R2.NBTTagCompound _tagCompound;

    public NBTTagCompound(){
        _tagCompound = new net.minecraft.server.v1_16_R2.NBTTagCompound();
    }

    public NBTTagCompound(net.minecraft.server.v1_16_R2.NBTTagCompound tagCompound){
    ...
    public INBTTagCompound copyRawByteArray(byte[] bytes) {
        _tagCompound = (net.minecraft.server.v1_16_R2.NBTTagCompound) baseFromByteArray(NBTTagType.COMPOUND, bytes);
        return this;
    }
